...
<section class="card event-detail"><div class="distance-highlight"><span>Distância total do percurso</span><strong><?=$distance?> km</strong></div><p><?=nl2br(e($event['desc_corrida']))?></p><div id="routeView" class="map large" data-start="<?=e($event['local_ini'])?>" data-end="<?=e($event['local_fin'])?>"></div><script type="application/json" id="savedRoute"><?=str_replace('</','<\/',$event['trajeto_json']??'null')?></script><div class="route-legend"><span><i class="start"></i><b>Largada</b> <?=e($event['local_ini'])?></span><span><i class="finish"></i><b>Chegada</b> <?=e($event['local_fin'])?></span></div></section><?php page_bottom();?>
